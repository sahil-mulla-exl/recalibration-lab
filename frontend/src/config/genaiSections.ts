...
export const RECALIBRATION_GENAI_SECTIONS = {
  recommended: ["recommended action", "ai-recommended action", "reasoning anchor"],
} as const;
...
export type RecalibrationGenAiSectionId = keyof typeof RECALIBRATION_GENAI_SECTIONS;

    ...
    <ChartFrame theme={theme} legend={legend}>
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={data} margin={chartMargin.xyTitles}>
          ...
          <Line type="monotone" dataKey="cum_pos_pct" stroke={theme.series.new} strokeWidth={2.5} dot={false} legendType="none" />
          <Line type="monotone" dataKey="cum_neg_pct" stroke={theme.series.dev} strokeWidth={2.5} dot={false} legendType="none" />
        </LineChart>
      </ResponsiveContainer>
    </ChartFrame>
  );

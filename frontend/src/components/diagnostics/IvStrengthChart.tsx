    ...
    <ChartFrame theme={theme} height={height} legend={legend}>
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={rows} layout="vertical" margin={horizontalBarMargin(yWidth, 4)}>
          ...
          <Bar dataKey="ivTrain" fill={theme.series.trainFill} stroke={theme.series.train} strokeWidth={1} legendType="none" />
          <Bar dataKey="ivNew" fill={theme.series.newFill} stroke={theme.series.new} strokeWidth={1} legendType="none" />
        </BarChart>
      </ResponsiveContainer>
    </ChartFrame>
  );

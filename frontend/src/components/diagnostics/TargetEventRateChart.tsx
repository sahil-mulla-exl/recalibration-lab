    ...
    <ChartFrame theme={theme} height={chartHeight} legend={legend}>
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={data} margin={chartMargin.xyTitles} barGap={8} barCategoryGap="20%">
          ...
          />
          <Bar dataKey="training" fill={theme.series.trainFill} stroke={theme.series.train} strokeWidth={theme.plot.barStrokeWidth} radius={[2, 2, 0, 0]} legendType="none" />
          <Bar dataKey="newData" fill={theme.series.newFill} stroke={theme.series.new} strokeWidth={theme.plot.barStrokeWidth} radius={[2, 2, 0, 0]} legendType="none" />
        </BarChart>
      </ResponsiveContainer>
    </ChartFrame>
  );

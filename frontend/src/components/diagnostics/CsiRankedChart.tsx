...
import { cartesianGrid, chartTooltipProps, formatChartValue, horizontalBarMargin, severityColor, useChartTheme } from "@/lib/chartTheme";
    ...
    <ChartFrame theme={theme} height={height}>
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={rows} layout="vertical" margin={horizontalBarMargin(yWidth, 4)}>
          ...
          <XAxis {...chartXAxis(theme, "CSI value", { type: "number", tickFormatter: fmt })} />
          <YAxis

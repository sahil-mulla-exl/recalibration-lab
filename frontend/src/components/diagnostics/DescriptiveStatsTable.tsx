      ...
      <table className="w-full table-fixed text-[10px] leading-tight sm:text-xs">
        <thead className="bg-gray-50 dark:bg-slate-900">
          <tr className="text-left">
            ...
            <th className="w-[7%] px-1 py-1.5 text-right font-semibold text-gray-900 dark:text-gray-100 truncate">{devLabel} S.D</th>
            <th className="w-[7%] px-1 py-1.5 text-right font-semibold text-gray-900 dark:text-gray-100 truncate">{newLabel} S.D</th>

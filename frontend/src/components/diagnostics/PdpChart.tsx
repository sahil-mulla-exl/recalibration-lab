      ...
      <ChartFrame theme={theme} legend={legend}>
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} margin={chartMargin.xyTitles}>
            ...
            <Bar dataKey="dev" fill={theme.series.trainFill} stroke={theme.series.train} strokeWidth={1} legendType="none" />
    ...
    <ChartFrame theme={theme} legend={legend}>
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={data} margin={chartMargin.xyTitles}>
          ...
          <Line type="monotone" dataKey="dev" stroke={theme.series.train} strokeWidth={2.5} dot={false} legendType="none" />
